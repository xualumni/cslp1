        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-4">
                        <!--Title and subtitle -->
                        <h1 class="page-header">Edit Profiles</h1>
                            <div class="row">
                                <div class="panel-body table-responsive">
                                    ...
                                    <?php
                                        ...
                                        echo "<br>";
                                        echo $this->Form->button(__('Save Profile'), ["class"=>"btn btn-info btn", "style"=> "background-color:#003B5F; border:0px; color:white;"]);
                                        echo $this->Form->end();
                                    ?>
                                </div>
                            </div>
